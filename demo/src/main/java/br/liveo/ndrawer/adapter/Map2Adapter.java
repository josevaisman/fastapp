...
import br.liveo.ndrawer.ui.fragment.Map2Fragment;

public class Map2Adapter extends MapViewPager.MultiAdapter {
    ...
    public Map2Adapter(FragmentManager fm) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        return Map2Fragment.newInstance(position);
    }
